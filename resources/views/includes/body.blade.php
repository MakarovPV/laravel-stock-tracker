<div class="col-10 row pt-2">
    <div id="body_div">
        <div class="card d-none" id="selected_stock_header">
            <div class="text-center ">
                <h1 id="stock_name_header" class="pt-1"></h1>
            </div>
        </div>

        <div class="row col-11 pt-2 d-none" id="stock_dashboard">
            <div class="col-1"></div>
            <div class="col-5 card h-50 chart">
                ...
                <div class="text-center text-secondary" id="chart_status_day"></div>
            ...
            <div class="col-5 card h-50  chart">
                ...
                <div class="text-center text-secondary" id="chart_status_week"></div>
            ...
            <div class="col-5 card h-50 chart">
                ...
                <div class="text-center text-secondary" id="chart_status_month"></div>
            ...
            <div class="col-5 card h-50 chart">
                ...
                <div class="text-center text-secondary" id="chart_status_year"></div>
